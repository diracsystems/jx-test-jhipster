package com.dirac.test.config.timezone;

import com.dirac.test.TestjhipsterApp;
import com.dirac.test.repository.timezone.DateTimeWrapper;
import com.dirac.test.repository.timezone.DateTimeWrapperRepository;
